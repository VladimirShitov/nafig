...
def create_example_data(n_obs: int = 1000, n_var: int = 300, mean_na: float = 0.5, std_na: float = 0.3) -> pd.DataFrame:
    ...
    feature_types = np.random.choice(["Continuous", "Categorical", "Binary"], size=df.shape[1])
